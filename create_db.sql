...
INSERT INTO `service_db`.`user` (`id`, `email`,  `first_name`,  `password`, `surname`) VALUES ('3', 'garry@yandex.ru', 'Garry', '$2a$10$L/LzfxrplFIUl0X5uElGwOuofhk3B9aFwMxC0suYHBD2UUnUoK1vG', 'Fat');
